    ...
    <PageShell>
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-slate-100/90">Современная браузерная версия с оффлайн AI и realtime матчами по ссылке.</p>
        </div>

        <div className="grid gap-5 md:grid-cols-2">
          <GlassCard className="space-y-4">
            <h2 className="font-display text-3xl">Оффлайн</h2>
            <p className="text-slate-100/85">Игра против AI, 3 уровня сложности, мгновенный реванш.</p>
            <Link
              to="/offline"
          ...
          <GlassCard className="space-y-4">
            ...
            <p className="text-slate-100/85">Создайте приватный матч, отправьте ссылку другу и играйте в real-time.</p>
            <Link
              to="/online/create"
